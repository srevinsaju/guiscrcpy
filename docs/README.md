...
These are the common methods of installation. To see more interesting ways, checkout [Installation wiki]( INSTALL.md) page for more information, and to find a compatible installtion method for your device and device architecture
...
1. [Installation]( INSTALL.md) (detailed)
2. [Features]( FEATURES.md)
3. [Configuration files]( CONFIGURATION.md)
4. [FAQ]( FAQ.md)
