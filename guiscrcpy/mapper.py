...
class Window(QtWidgets.QWidget):
    def __init__(self):
        ...
        self.charm.setMaximumSize(QtCore.QSize(60, 60))
        self.charm.setObjectName("charm")
        self.horizontalLayout.addWidget(self.charm)"""
        ...
        def on_release(key):
            ...
            try:
                if key.char == "o":
                    ...
                    finalpos[0] = fixx
                    finalpos[1] = fixy
                    self.label0.setText("Position registered! Enter a key to register the position to character.")
