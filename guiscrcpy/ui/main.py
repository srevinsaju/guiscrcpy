...
"")
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(":/icons/icons/bullseye.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.gridLayout_4.addWidget(self.refreshdevices, 6, 5, 1, 1)
        ...
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap(":/icons/icons/reorder-option.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.check_side_panel.setIcon(icon4)
        ...
        self.check_bottom_panel.setIcon(icon4)
        ...
        self.gridLayout_4.addWidget(self.devices_combox, 6, 2, 1, 3)
        ...
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap(":/icons/icons/wifi.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.network_button.setIcon(icon6)
        ...
        icon8 = QtGui.QIcon()
        icon8.addPixmap(QtGui.QPixmap(":/icons/icons/hand-finger-pointing-down.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.showTouches.setIcon(icon8)
        ...
        icon9 = QtGui.QIcon()
        icon9.addPixmap(QtGui.QPixmap(":/icons/icons/bell-musical-tool.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.notifChecker.setIcon(icon9)
        self.notifChecker.setObjectName("notifChecker")
        self.gridLayout_4.addWidget(self.notifChecker, 1, 4, 1, 1)
        self.lock_rotation = QtWidgets.QCheckBox(self.frame1)
        self.lock_rotation.setIcon(icon4)
        self.lock_rotation.setObjectName("lock_rotation")
        self.gridLayout_4.addWidget(self.lock_rotation, 3, 5, 1, 1)
        self.device_rotation = QtWidgets.QComboBox(self.frame1)
        ...
        self.device_rotation.addItem("")
        self.device_rotation.addItem("")
        self.gridLayout_4.addWidget(self.device_rotation, 3, 0, 1, 5)
        ...
        self.bitrateText = QtWidgets.QLineEdit(self.frame1)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
...
"image: url(:/res/ui/guiscrcpy_logo.png);")
        ...
        self.dimensionText = QtWidgets.QLineEdit(self.frame1)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
