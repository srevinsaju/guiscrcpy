...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        print("LOG: MainUI loaded")
        QtGui.QFontDatabase.addApplicationFont(":/res/fonts/trebucbd.ttf")
        QtGui.QFontDatabase.addApplicationFont(":/res/fonts/trebuc.ttf")
...
"")
        ...
        self.label_4.setMinimumSize(QtCore.QSize(5, 5))
        ...
        self.gridLayout_4.addWidget(self.displayForceOn, 1, 0, 1, 2)
        ...
        self.gridLayout_4.addWidget(self.showTouches, 0, 2, 1, 1)
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap(":/icons/icons/facetime-button.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.recScui.setIcon(icon3)
        self.recScui.setObjectName("recScui")
        self.gridLayout_4.addWidget(self.recScui, 1, 2, 1, 1)
        ...
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap(":/icons/icons/increase-size-option.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.fullscreen.setIcon(icon4)
        self.fullscreen.setObjectName("fullscreen")
        self.gridLayout_4.addWidget(self.fullscreen, 0, 1, 1, 1)
...
"image: url(:/res/ui/guiscrcpy_logo.png);")
        ...
        self.quit.setText("")
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap(":/icons/icons/cross-mark-on-a-black-circle-background.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.quit.setIcon(icon6)
        ...
        self.abtgit.setText("")
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap(":/icons/icons/github.logo.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.abtgit.setIcon(icon7)
        ...
        icon9 = QtGui.QIcon()
        icon9.addPixmap(QtGui.QPixmap(":/icons/icons/small-rocket-ship-silhouette.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.executeaction.setIcon(icon9)
